...
console.log(as2[0], as2[2], as2[6], as2[8], as2[9], as2[15], as2[16])

function unitConvert(times, num) {
  if(num / 1024 < 1) {
    return {num, times}
  } else {
    return unitConvert(times + 1, num / 1024)
  }
}

console.log(unitConvert(0, 2049))
